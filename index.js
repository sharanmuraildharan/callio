...
// Constants
const SYSTEM_MESSAGE = 'You are an AI tech support agent for callio. Your job is to politely engage with the client and obtain their name, queries, and give suggestion. Ask one question at a time. Do not ask for other contact information, and ask the customer if they want to speak to a person for unsolveable problems. Ensure the conversation remains friendly and professional, and guide the user to provide these details naturally. If necessary, ask follow-up questions to gather the required information.';
const VOICE = 'Sage';
...
fastify.all('/incoming-call', async (request, reply) => {
    ...
    const twimlResponse = `<?xml version="1.0" encoding="UTF-8"?>
                          <Response>
                              <Say>Hi, you have called callio your AI tech support agent. How can we help?</Say>
                              <Connect>
